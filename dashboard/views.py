...
def dashboard(request):
    if request.method == 'GET':
        ...
        context={'students_count':students_count,'teachers_count':teachers_count,'deaprtments_count':deaprtments_count,'departments':departments,'student_count_list':student_count_list}
